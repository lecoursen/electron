...
function getCurrentStack (caller) {
  const target = {}
  if (enableStacks) {
...
exports.require = (module) => {
  ...
  const meta = ipcRendererInternal.sendSync(command, contextId, module, getCurrentStack(exports.require))
  return metaToValue(meta)
}
...
exports.getBuiltin = (module) => {
  ...
  const meta = ipcRendererInternal.sendSync(command, contextId, module, getCurrentStack(exports.getBuiltin))
  return metaToValue(meta)
}

exports.getCurrentWindow = () => {
  const command = 'ELECTRON_BROWSER_CURRENT_WINDOW'
  const meta = ipcRendererInternal.sendSync(command, contextId, getCurrentStack(exports.getCurrentWindow))
  return metaToValue(meta)
}
...
exports.getCurrentWebContents = () => {
  ...
  const meta = ipcRendererInternal.sendSync(command, contextId, getCurrentStack(exports.getCurrentWebContents))
  return metaToValue(meta)
}
...
exports.getGlobal = (name) => {
  ...
  const meta = ipcRendererInternal.sendSync(command, contextId, name, getCurrentStack(exports.getGlobal))
  return metaToValue(meta)
}
...
exports.getGuestWebContents = (guestInstanceId) => {
  ...
  const meta = ipcRendererInternal.sendSync(command, contextId, guestInstanceId, getCurrentStack(exports.getGuestWebContents))
  return metaToValue(meta)
}
