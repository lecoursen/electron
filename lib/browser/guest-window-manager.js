...
ipcMainInternal.on('ELECTRON_GUEST_WINDOW_MANAGER_WINDOW_OPEN', (event, url, referrer, frameName, features) => {
  if (url == null || url === '') url = 'about:blank'
  if (referrer == null) referrer = { url: '', policy: 'no-referrer-when-downgrade' }
