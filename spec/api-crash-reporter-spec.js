...
ifdescribe(!process.mas && process.platform !== 'linux')('crashReporter module', () => {
  ...
  before(() => {
    ...
    app.setPath('temp', '/Users/nitish/Repos/crashtest')
  })
  ...
  const generateSpecs = (description, browserWindowOpts) => {
    describe(description, () => {
      ...
      // ifit(!browserWindowOpts.webPreferences.sandbox)('should send minidump with updated extra parameters when node processes crash', function (done) {
